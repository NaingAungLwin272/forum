export const environment = {
    production: true,
    apiEndpoint: 'https://gateway-mtm.onrender.com/api',
    cloudName: 'dkjvy425b',
    preset: 'wiwif6wa',
    angularBaseUrl: 'https://mtm-community-forum.onrender.com',
    firebase: {
        ...
        vapidKey: "BKc9o59_ASEa-Jh8L8oPh_1oDUU1TkDuCoEi32pmPV79djYxvKUT-8NWZUQ0rMHOUf0i0-bCNZ8_SxRybWjG_Tk"
    }
};
