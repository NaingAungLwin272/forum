...
import (
	...
	"github.com/scm-dev1dev5/mtm-community-forum/noti_rpc/gapi"
...
func init() {
	...
	notiCollection = mongoclient.Database("mtm_community_forum").Collection("noties")
	notiService = services.NewNotiService(notiCollection, ctx)
...
func startGrpcServer(config config.Config) {
	userServer, err := gapi.NewGrpcNotiServer(notiCollection, notiService)
	if err != nil {
	...
	pb.RegisterNotiServiceServer(grpcServer, userServer)
